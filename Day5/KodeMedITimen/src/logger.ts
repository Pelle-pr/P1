...
//Selv lave en generic klasse som Array<string> f.eks
...
let enAndenLogger = new GenericLogger<number, string>();
personLogger.log(p1, a1);
enAndenLogger.log(4, "hej");
